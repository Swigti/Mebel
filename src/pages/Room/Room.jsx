            ...
            <form className="room__form">
              ...
              <div className="room__form-inputs">
                <label>
                  ...
                  <input type="text" className="room__form-input" />
                </label>
                <label>
                  <p className="room__form-text">Имя</p>
                  <input type="email" className="room__form-input" />
                </label>
                <label>
                ...
                <label>
                  ...
                  <input type="password" className="room__form-input" />
                </label>
              </div>
              <label>
                <p className="room__form-text">Город</p>
                <input className="room__form-input width" type="text" />
              </label>
              <label>
              ...
              <table cellSpacing={0} className="room__table">
                ...
                <tr>
                  <td className="room__orders-td">
                    <div>
                      <img src={image} alt="" />
                      <h3 className="roow__orders-sTitle">Кускен Navy Blue</h3>
                    </div>
                  </td>
                  <td className="room__orders-td">
                    <p className="room__orders-text">16990</p>
                  </td>
                  <td className="room__orders-td">
                    <p className="room__orders-text">01.05.2020</p>
                  </td>
                  <td className="room__orders-td">
                ...
                <tr>
                  ...
                  <td className="room__orders-td">
                    <p className="room__orders-text">Оплачено 50%</p>
                  </td>
                </tr>
                <tr>
                  <td className="room__orders-td">
